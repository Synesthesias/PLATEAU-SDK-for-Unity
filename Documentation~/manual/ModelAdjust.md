...
動的タイルをゲームオブジェクトON/OFF機能の対象として指定することができます。  
...
動的タイルを分割・結合・マテリアル分け機能の対象として指定することができます。  
動的タイルを対象に設定した場合、処理完了後に対応するアセットバンドルが自動的に上書き更新され、変更結果が即座に反映されます。
...
動的タイルを分割／結合／マテリアル分けの対象として指定することができます。  
動的タイルを扱う際には次のような操作が可能です。

![](../resources/manual/cityAdjust/DynamicTiles.png)
...
特定の動的タイルを 常に最高解像度で固定表示 することができます。

![](../resources/manual/cityAdjust/highquality.png)
