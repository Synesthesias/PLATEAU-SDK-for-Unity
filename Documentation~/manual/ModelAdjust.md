...
> [!NOTE]  
> 地形モデルはテレインに変換して平滑化をしています。テレインはUnityエディタで手動で高さ調整ができるので、気になる部分があればユーザー側で微調整が可能です。詳しい内容は[こちら](https://docs.unity3d.com/ja/2019.4/Manual/terrain-UsingTerrains.html)。また、急傾斜の地形の場合、地形の高さ合わせが不自然になることがあります。
